...
import 'package:rotaract/repos/auth_repository.dart';
...
final watchCurrentUserProvider = StreamProvider.autoDispose<MemberModel>((ref) {
...
final watchUserInfoProvider =
    StreamProvider.autoDispose.family<MemberModel, String>((ref, id) {
